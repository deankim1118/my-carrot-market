...
export default function TabBar() {
  ...
  return (
    <div className='fixed bottom-0 w-full grid grid-cols-5 border-neutral-600 border-t px-5 py-3 *:text-white bg-neutral-800 md:max-w-screen-md md:self-center'>
